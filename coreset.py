...
def coresetConstruction(points, centers, epsilon=0.2):
    coreset = []
    ...
    radius = math.sqrt(cost(points, centers) / (a * log_n * n))
    ...
    for j in range(0, math.ceil(z)):
        ...
        for center in centers:
            for square in allSquaresInCircle(center, radius_to_power, x):
